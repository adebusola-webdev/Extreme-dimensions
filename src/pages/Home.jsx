                ...
                <div className="header__inner__con">
                    ...
                    <div className="header__mini__text">
                        <div className="consultation__con">
                            ...
                            <a href=""  className='btn__link'><div className='btn'>
            ...
            <section className="our-service__section">
                <div className="our__service__con">
                    ...
                    <div className="service__inner__con">
                        <div className="service__left__con">
                            ...
                            <p>We design spaces that blend functionality with aesthetics, including</p>
                            <div className='service__image'>
                                <img src="https://res.cloudinary.com/dw3vqhvte/image/upload/v1720278166/picture_2_z64tle.png" alt="" />
                            </div>
                        ...
                        <div className="service__right__con">
                            ...
                            <p className='learn'> <Link className='who_link'>Learn more </Link></p>
                ...
                <div className="engineering__con">
                    <div className="engineering__img">
                        <img src="https://res.cloudinary.com/dw3vqhvte/image/upload/v1720278168/picture_3_ykcxht.png" alt="" />
                    </div>
                    <div className="engineering__text__con">
                        <h1>Engineering</h1>
                        <p>We provide reliable engineering solutions for seamless construction processes, focusing on</p>
                        <div className="list__con">
                            <div className='list__item'>
                                <p>/</p>
                ...
                <div className="engineering__con landscaping">
                    <div className="engineering__img">
                        <img src="https://res.cloudinary.com/dw3vqhvte/image/upload/v1720278172/picture_5_x9qxor.png" alt="" />
                    </div>
                    <div className="engineering__text__con">
                        <h1>Landscaping</h1>
                        <p>Our expertise extends to outdoor spaces, enhancing environments through landscaping</p>
                        <div className="list__con">
                            <div className='list__item'>
                                <p>/</p>
                ...
                <div className="engineering__con ">
                    <div className="engineering__img">
                        <img src="https://res.cloudinary.com/dw3vqhvte/image/upload/v1720278166/picture_4_drvlfg.png" alt="" />
                    </div>
                    <div className="engineering__text__con">
                    ...
                    <div className="build__inner__con">
                        ...
                        <div className="build__image__con">
                            <div className="big__image">
                                <img src="https://res.cloudinary.com/dw3vqhvte/image/upload/v1720278173/picture_6_eyx5tg.png" alt="" />
                            </div>
                            <div className="double__Image">
                                <img src="https://res.cloudinary.com/dw3vqhvte/image/upload/v1720278172/picture_8_ysqijx.png" alt="" />
                                <img src="https://res.cloudinary.com/dw3vqhvte/image/upload/v1720278169/picture_7_fiox2t.png" alt="" />
                            </div>
                        </div>
                    </div>
                </section>
